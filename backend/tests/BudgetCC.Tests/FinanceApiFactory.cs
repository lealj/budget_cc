...
namespace BudgetCC.Tests;

public sealed class FinanceApiFactory : WebApplicationFactory<Program>
{
    private readonly string databasePath = Path.Combine(Path.GetTempPath(), $"budgetcc-test-{Guid.NewGuid():N}.db");
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configuration) => configuration.AddInMemoryCollection(new Dictionary<string, string?>
        {
            ...
            ["Authentication:Audience"] = "budgetcc-tests"
        }));
    ...
    public string Token(string? workspace = "workspace-a", string subject = "test-member", string audience = "budgetcc-tests",
